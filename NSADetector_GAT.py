...
type_file_path = "2GAT 64_128 1FC 32 data_4_class_20000 graph2 NEW 500.txt"
...
acc = open("./GAT Test/new 1000 accurency major.txt", "a+")
testdir = "./GAT Test/"
...
for threshold in np.arange(0.00, 0.8, 0.05):
    # threshold  += 0.05
# for threshold in np.arange(0.05, 1, 0.05):
    ...
    # hybridAccuracy = testAccuracy(model, threshold, major, (hybridattack_graph1), attackSamples,
    #                           [4] * len(hybridattack_data1), testdir + "hybrid incorrect" + file)
