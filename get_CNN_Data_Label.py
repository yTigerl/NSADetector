import zipfile
root_dir = "E:/Ethereum Data/Attack/cnn formatting/"
bundle_types = ["CSA", "MLS", "LF", "MPS", "Non"]
bundle_types = ["CSA", "MLS", "LF", "Non"]
# bundle_types = ["Non"]

# bundle_types = ["CSA", "MLS", "LF", "MPS", "Non", "HLM", "LPM", "MBS"' "MPS", "MLL", "LR"]
data_file = "E:/Ethereum Data/Attack/cnn formatting/" + bundle_types[0] + "/merge.txt"
target_file = "E:/Ethereum Data/Attack/label/" + bundle_types[0] + " merge label.txt"
data_file = "E:/Ethereum Data/Attack/cnn formatting/" + bundle_types[0] + "/merge 20000_21000.txt"
target_file = "E:/Ethereum Data/Attack/label/" + bundle_types[0] + " merge label 20000_21000.txt"
data_file = "E:/Ethereum Data/Attack/cnn formatting/" + bundle_types[0] + "/merge 42671_50202.txt"
...
dexs = ["merge 20000.txt"]
# , "merge 42671_50202.txt"
                ...
                with open(input_file, 'r') as f_in:
                    ...
                    for line in f_in:
                        ...
                        if line.strip():  # 跳过空行
                            ...
                            #     data.append([transactionHash, blockNumber, pairAddress, type, send, to, amount0, amount1])
                            # else:
                            #     transactionHash, blockNumber, pairAddress, type, send, to, amount0In, amount1In, amount0Out, amount1Out =  line.split()
                            #     data.append([transactionHash, blockNumber, pairAddress, type, send, to, amount0In, amount1In, amount0Out, amount1Out])

                            pairAddress_index, send_index, to_index, amount0In, amount1In, amount0Out, amount1Out, type, t1, t2, t3 = line.split()
                            data.append([pairAddress_index, send_index, to_index, amount0In, amount1In, amount0Out, amount1Out, type, t1, t2, t3])
                        else:
                            print(count)
